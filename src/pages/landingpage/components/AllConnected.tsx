    ...
    <div className="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
      <div className="lg:grid lg:grid-cols-12 lg:items-center lg:justify-between lg:gap-16">
        <div className="lg:col-span-5 lg:col-start-1">
          <div className="mb-8">
            <h2 className="mb-2 text-3xl font-bold text-gray-50 lg:text-4xl">
          ...
          {/* <blockquote className="relative">
            ...
            <div className="relative z-10">
              <p className="text-xl italic text-gray-50">
        ...
        <div className="mt-10 lg:col-span-6 lg:col-end-13 lg:mt-0">
          <div className="space-y-6 sm:space-y-8">
            <ul className="grid grid-cols-2 divide-x-2 divide-y divide-gray-200 overflow-hidden">
              <li className="-m-0.5 flex flex-col p-4 sm:p-8">
                <div className="mb-2 flex items-end gap-x-2 text-3xl font-bold text-gray-50 sm:text-5xl">
                  45k+
                </div>
